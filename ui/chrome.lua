...
function M.push_theme()
    ...
    push_color(ImGuiCol_ChildBg, {0, 0, 0, 0})
    ...
    push_color(ImGuiCol_FrameBg, bg_medium)
    push_color(ImGuiCol_FrameBgHovered, bg_light)
    push_color(ImGuiCol_FrameBgActive, bg_lighter)
    ...
    push_color(ImGuiCol_Border, border_dark)
    push_color(ImGuiCol_Text, text_light)
    push_color(ImGuiCol_TextDisabled, gold_dark)
    push_color(ImGuiCol_Button, bg_medium)
    push_color(ImGuiCol_ButtonHovered, bg_light)
    push_color(ImGuiCol_ButtonActive, bg_lighter)
    ...
    push_var(ImGuiStyleVar_FramePadding, {6, 4})
    push_var(ImGuiStyleVar_ItemSpacing, {8, 6})
